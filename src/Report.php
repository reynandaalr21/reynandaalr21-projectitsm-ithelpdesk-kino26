...
class Report extends CommonGLPI
{
    ...
    public static function getReports(): array
    {
        ...
        if (
            ...
            $report_list["state"]["file"] = "/glpi/front/report.state.php";
        }
    ...
    public static function title()
    {
        $twig_params = [
            ...
            'selected' => -1,
            'values'   => ['/glpi/front/report.php' => Dropdown::EMPTY_VALUE],
        ];
